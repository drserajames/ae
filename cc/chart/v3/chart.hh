...
namespace ae::chart::v3
{
    ...
    class Chart
    {
      public:
        ...
        // Bake a named semantic style (c["R"][style_name]) into the legacy per-point plot
        // spec (c["p"]); native reproduction of kateri's plotSpecLegacy().setFrom(...).
        // Implemented in cc/chart/v3/semantic-to-legacy.cc.
        void semantic_style_to_legacy(std::string_view style_name);
