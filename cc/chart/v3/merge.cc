...
namespace ae::chart::v3
{
    ...
    static Titers::titer_merge_report merge_titers(Chart& merge, const Chart& chart1, const Chart& chart2, const merge_data_t& merge_data, double sd_limit, sd_denominator denom);
...
std::pair<std::shared_ptr<ae::chart::v3::Chart>, ae::chart::v3::merge_data_t> ae::chart::v3::merge(std::shared_ptr<Chart> chart1, std::shared_ptr<Chart> chart2, const merge_settings_t& settings)
{
    try {
        ...
        merge_data.titer_report(merge_titers(*merged, *chart1, *chart2, merge_data, settings.sd_limit, settings.sd_denominator_));
...
ae::chart::v3::Titers::titer_merge_report ae::chart::v3::merge_titers(Chart& merge, const Chart& chart1, const Chart& chart2, const merge_data_t& merge_data, double sd_limit, sd_denominator denom)
{
    ...
    return titers.set_from_layers(merge, sd_limit, denom);
